...
from barycentric_polygonal_interpolation1 import get_drifter_track,get_fvcom,get_roms,calculate_SD,drifterhr
######## Hard codes ##########
...
'''
    ...
    for nday in np.arange(1,days+1,restart_days): 
        ...
        try:
            ...
            if start_time.month!=end_times.month:
                end_times=end_times+timedelta(hours=1)
        except:
            continue
        print start_time
        print end_times
...
csvfile = file('drifter_vs_model use hourly data8.csv', 'wb')
